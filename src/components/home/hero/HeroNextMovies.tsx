...
function HeroNextMovies({ movie }: { movie: Results }) {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-3/4 h-[] bg-accent/50 relative rounded-lg overflow-hidden rounded-br-none group ">
      ...
      <div className="h-[11.5rem] -translate-y-8 shadow-[0_-18px_15px_5px_rgba(0,0,0,0.5)] relative">
